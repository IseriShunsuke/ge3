...
void Sprite::Initialize(SpriteCommon* spriteCommon, std::string textureFilePath)
{
	...
	indexResource = dxcommond_->CreateBufferResource(sizeof(uint32_t) * 6);
	...
	materialResource = dxcommond_->CreateBufferResource(sizeof(Material));
	...
	transformationMatirxResource = dxcommond_->CreateBufferResource(sizeof(TransformMatrix));
	transformationMatirxData = nullptr;
	transformationMatirxResource->Map(0, nullptr, reinterpret_cast<void**>(&transformationMatirxData));
	transformationMatirxData->WVP = MakeIdentity4x4();
	transformationMatirxData->World = MakeIdentity4x4();

	transformationMatirxResourceSprite = dxcommond_->CreateBufferResource(sizeof(TransformMatrix));
	transformationMatirxDataSprite = nullptr;
